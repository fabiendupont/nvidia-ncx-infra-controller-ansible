...
options:
  ...
  query:
    type: str
    description:
    - Search for matches across all Sites. Input will be matched against name, display name, description and status fields
  site_id:
    type: str
    description:
...
ARGUMENT_SPEC = dict(
exclude_unallocated=dict(type='bool'),
id=dict(type='str'),
include_allocation_stats=dict(type='bool'),
